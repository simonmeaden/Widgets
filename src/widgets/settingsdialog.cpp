...
int
SettingsDialog::addTab(ISettingsDialog* parentWidget, const QString& label)
{
//  if (parentWidget) {
//    auto settingsWidget =
//      qobject_cast<SettingsWidget*>(parentWidget->settingsPages());
//    if (settingsWidget) {
//      return m_tabs->addTab(parentWidget->settingsPages(), label);
//    }
//  }
  return -1;
}
...
int
SettingsDialog::addTab(ISettingsDialog *parentWidget,
                       const QIcon& icon,
                       const QString& label)
{
//  if (parentWidget) {
